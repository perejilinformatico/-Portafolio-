...
function App() {
  ...
  return (
    <>
    <div>
          <div className='bg-gray-300 flex justify-center items-center flex-col text-center gap-3' id='menu_desplegable' style={{ display: active ? 'flex' : 'none' }} onClick={handClick}>
